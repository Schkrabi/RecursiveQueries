...
class SelectionConditionTest {
	...
	Attribute<String> b;
	Record r1, r2, r3;
	ISimilarity<Integer> intSimilarity;
	...
	void setUp() throws Exception {
		...
		r3 = Record.factory(
				...
				Arrays.asList(
						...
						new Record.AttributeValuePair<>(b,"foo")), 
				0.8d);	
		this.intSimilarity = LinearSimilarities.integerSimilarityUntil(1);
	}
	...
	void testConnectives() {
		...
		var similar = new Similar<>(a, new Constant<Integer>(0), this.intSimilarity);
		c = new ProductAnd(
				similar,
				similar);
