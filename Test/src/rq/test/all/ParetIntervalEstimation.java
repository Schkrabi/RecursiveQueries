...
class ParetIntervalEstimation {
	...
	MemoryTable t1;
	Selection s1;
	IntervalEstimation<Double> e1;
	rq.common.similarities.ISimilarity<Double> similarity = rq.common.similarities.LinearSimilarities.doubleSimilarityUntil(10.0d);
