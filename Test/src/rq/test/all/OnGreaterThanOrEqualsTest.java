...
class OnGreaterThanOrEqualsTest {

	Schema schema1, schema2;
	Attribute a, b, c;
	Record r11, r12, r21, r22;
	OnGreaterThanOrEquals onGreaterThanOrEquals;
	...
	void setUp() throws Exception {
		...
		onGreaterThanOrEquals = OnGreaterThanOrEquals.factory(a, a);
	}

	@Test
	void testEval() {
		assertEquals(1.0d, onGreaterThanOrEquals.eval(r22, r11));
		assertEquals(1.0d, onGreaterThanOrEquals.eval(r11, r11));
		assertEquals(0.0d, onGreaterThanOrEquals.eval(r11, r22));
	}
	...
	void testFactory() {
		assertThrows(
				...
				() -> OnGreaterThanOrEquals.factory(new Attribute("foo", Object.class), a));
		assertThrows(
				ComparableDomainMismatchException.class,
				() -> OnGreaterThanOrEquals.factory(a, b));	
	}
