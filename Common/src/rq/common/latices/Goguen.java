...
public class Goguen {
	public static final BinaryOperator<Double> PRODUCT = (Double x, Double y) -> x*y;
	public static final BinaryOperator<Double> RESIDUUM = (Double x, Double y) -> x < y ? 1.0d : y/x; 
